...
{{< figure src="/blog/media/2016-03-06-watch-latex-documents-using-latexmk/textmate_watch_document.gif" title="The watch document command of Textmate previews changes when saving the document" >}}
...
{{< figure src="/blog/media/2016-03-06-watch-latex-documents-using-latexmk/synctex_sublime_skim.gif" title="Jump between the IDE (Sublime Text 3 with LatexTools) and the PDF Viewer (Skim) using the Synctex feature" >}}
